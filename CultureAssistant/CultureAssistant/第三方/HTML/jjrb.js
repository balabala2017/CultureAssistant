...
//function add_playVideo_defaultImg()
//{
//    var videoElements = document.getElementsByTagName("video");
//    if(videoElements!= null)
//    {
//        for(var e :videoElements)
//        {
//            e.tagName("div");
//            String url = e.attr("src");
//            String img = e.attr("twsmsrc");
//            e.attr("class","video");
//            e.attr("onclick","openVideo('"+url+"')");
//            e.attr("style","position:relative");
//            if(TextUtils.isEmpty(img)){
//                img = "pic_video_default.jpg";
//            }
//            Element imgNode = doc.createElement("img");
//            imgNode.attr("src",img);
//            imgNode.attr("class","video");
//            imgNode.attr("style", "width:99% !important; height:auto !important; margin-left:1% !important; ");
//            e.appendChild(imgNode);
//            
//            Element playNode = doc.createElement("div");
//            playNode.attr("style", " position:absolute; top:0; left:0; width:100%; height:100%; background:url(pic_video_default.png) no-repeat center center; background-size:60px 60px; z-index:1000;");
//            e.appendChild(playNode);
//        }
//    }
//}
        ...
        for(var i=0;i<data.rows.length;i++){
            if(i==0){
                ...
                if(data.rows[i].iterm3!=null && data.rows[i].iterm4==null && data.rows[i].iterm5==null && data.rows[i].iterm6==null && data.rows[i].iterm7==null && data.rows[i].iterm8==null){
                    $("#voteQuestion").study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"},{"name":data.rows[i].iterm3,"data":data.rows[i].iterm3Number,"color":"#CB1D33"}]);
                    ...
                    $("#voteQuestion").study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"},{"name":data.rows[i].iterm3,"data":data.rows[i].iterm3Number,"color":"#CB1D33"}
                                                   ,{"name":data.rows[i].iterm4,"data":data.rows[i].iterm4Number,"color":"#CB1D33"}]);
                }else if(data.rows[i].iterm5!=null && data.rows[i].iterm6==null && data.rows[i].iterm7==null && data.rows[i].iterm8==null){
                    $("#voteQuestion").study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"},{"name":data.rows[i].iterm3,"data":data.rows[i].iterm3Number,"color":"#CB1D33"}
                                                   ,{"name":data.rows[i].iterm4,"data":data.rows[i].iterm4Number,"color":"#CB1D33"},{"name":data.rows[i].iterm5,"data":data.rows[i].iterm5Number,"color":"#CB1D33"}]);
                }else if(data.rows[i].iterm6!=null && data.rows[i].iterm7==null && data.rows[i].iterm8==null){
                    $("#voteQuestion").study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"},{"name":data.rows[i].iterm3,"data":data.rows[i].iterm3Number,"color":"#CB1D33"}
                                                   ,{"name":data.rows[i].iterm4,"data":data.rows[i].iterm4Number,"color":"#CB1D33"},{"name":data.rows[i].iterm5,"data":data.rows[i].iterm5Number,"color":"#CB1D33"},{"name":data.rows[i].iterm6,"data":data.rows[i].iterm6Number,"color":"#CB1D33"}]);
                }else if(data.rows[i].iterm7!=null && data.rows[i].iterm8==null){
                    $("#voteQuestion").study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"},{"name":data.rows[i].iterm3,"data":data.rows[i].iterm3Number,"color":"#CB1D33"}
                                                   ,{"name":data.rows[i].iterm4,"data":data.rows[i].iterm4Number,"color":"#CB1D33"},{"name":data.rows[i].iterm5,"data":data.rows[i].iterm5Number,"color":"#CB1D33"}
                                                   ,{"name":data.rows[i].iterm6,"data":data.rows[i].iterm6Number,"color":"#CB1D33"},{"name":data.rows[i].iterm7,"data":data.rows[i].iterm7Number,"color":"#CB1D33"}]);
                }else if(data.rows[i].iterm8!=null){
                    $("#voteQuestion").study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"},{"name":data.rows[i].iterm3,"data":data.rows[i].iterm3Number,"color":"#CB1D33"}
                                                   ,{"name":data.rows[i].iterm4,"data":data.rows[i].iterm4Number,"color":"#CB1D33"},{"name":data.rows[i].iterm5,"data":data.rows[i].iterm5Number,"color":"#CB1D33"}
                                                   ,{"name":data.rows[i].iterm6,"data":data.rows[i].iterm6Number,"color":"#CB1D33"},{"name":data.rows[i].iterm7,"data":data.rows[i].iterm7Number,"color":"#CB1D33"},{"name":data.rows[i].iterm8,"data":data.rows[i].iterm8Number,"color":"#CB1D33"}]);
                }
                else{
                    $("#voteQuestion").study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"}]);
                }
                ...
                $('#form1').remove();
                if(data.rows[i].iterm3!=null && data.rows[i].iterm4==null && data.rows[i].iterm5==null && data.rows[i].iterm6==null && data.rows[i].iterm7==null && data.rows[i].iterm8==null){
                    $("#voteQuestion"+i).study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"},{"name":data.rows[i].iterm3,"data":data.rows[i].iterm3Number,"color":"#CB1D33"}]);
                }else if(data.rows[i].iterm4!=null && data.rows[i].iterm5==null && data.rows[i].iterm6==null && data.rows[i].iterm7==null && data.rows[i].iterm8==null){
                    $("#voteQuestion"+i).study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"},{"name":data.rows[i].iterm3,"data":data.rows[i].iterm3Number,"color":"#CB1D33"}
                                                     ,{"name":data.rows[i].iterm4,"data":data.rows[i].iterm4Number,"color":"#CB1D33"}]);
                }else if(data.rows[i].iterm5!=null && data.rows[i].iterm6==null && data.rows[i].iterm7==null && data.rows[i].iterm8==null){
                    ...
                    $("#voteQuestion"+i).study_vote([{"name":data.rows[i].iterm1,"data":data.rows[i].iterm1Number,"color":"#CB1D33"},{"name":data.rows[i].iterm2,"data":data.rows[i].iterm2Number,"color":"#CB1D33"}]);                       	
                }
            }
        }
        $("#submitVote").val("投票已结束");
        $("#submitVote").css({"background":"#333","border":"none","border-radius":"-10px","text-align":"center"});
...
//	var data = $.parseJSON(data);
	...
	if(data.resultCode==200){
        ...
        $("#submitVote").val("您已投票");
        $("#submitVote").css({"background":"#333","border":"none","border-radius":"-10px"});
        $("#submitVote").attr({"disabled":"disabled"});
    }
}
...
$.fn.study_vote= function(options,totle){
	...
	var study_votestr="";
		for(i=0;i<settings.length;i++)
		{
            ...
            var studyplay_present=study_voteCount!=0?settings[i].data/study_voteCount*100:0;
